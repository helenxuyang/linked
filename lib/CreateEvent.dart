                      ...
                      children: [
                        ...
                        Form(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Event Name", style: Theme.of(context).textTheme.headline3),
                                TextFormField(
                                  focusNode: _focusNode,
                                  textInputAction: TextInputAction.next,
                                  decoration: InputDecoration(hintText: 'PowerPoint Palooza Spectacular'),
                                  maxLength: 20,
                                  validator: (input) {
                                    if (input.isEmpty) {
                                ...
                                SizedBox(height: 12),
                                Text('Event Type', style: Theme.of(context).textTheme.headline3),
                                ...
                                if (_isVirtual)
                                  Padding(
                                    ...
                                    child: Text('Optional, leave blank to generate Google Meet URL'),
                                  ),
                                TextFormField(
                                  textInputAction: TextInputAction.next,
                                  validator: (value) {
                                  ...
                                  decoration: InputDecoration(hintText: _type == Event.appOptions[0] ? 'example.com' : 'Arts Quad'),
                                ),
                                SizedBox(height: 12),
                                Text("Description", style: Theme.of(context).textTheme.headline3),
                                TextFormField(
                                    textInputAction: TextInputAction.next,
                                    decoration: InputDecoration(hintText: 'Come hang out with me! I\'m very cool and fun.'),
                                    maxLength: 200,
                                    validator: (input) {
                                      if (input.isEmpty) {
                                ...
                                Text('Event End Time',
                                    style: Theme.of(context).textTheme.headline3),
                                DateTimeSelections(DateTime.now().add(Duration(hours: 1)), setEnd),
                                SizedBox(height: 12),
                                Text('Max Attendees', style: Theme.of(context).textTheme.headline3),
                                ListTile(
                                ...
                                SizedBox(height: 4),
                                Text('Hit enter after each tag, tap on a tag to delete it'),
                                TextFormField(
                                  textInputAction: TextInputAction.next,
                                ...
                                return FlatButton(
                                    ...
                                    onPressed: () {
                                      if (_startTime.isAfter(_endTime)) {
                                        Scaffold.of(context).showSnackBar(SnackBar(content: Text('Start time must be before end time!')));
                                      }
