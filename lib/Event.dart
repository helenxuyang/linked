          ...
          child:
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  return InputChip(
                      avatar: CircleAvatar(
                          child: Image.network(organizerDoc.get('photoURL'))),
                  ...
                  return Wrap(
                    ...
                    return FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          ...
                          String imgURL = attendeeDoc.get('photoURL');
                          String firstName = attendeeDoc.get('firstName');
                          String lastName = attendeeDoc.get('lastName');
